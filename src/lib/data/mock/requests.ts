...
export const REQUESTS_FALLBACK: EnrichmentRequestRow[] = [
  ...
  { id: "2", student: "George Lee", parent: "Mr. Lee", class: "Journalism & Media Writing", block: "B4", level: "4", option: "2nd", status: "Pending" },
  { id: "3", student: "Bruna Lee", parent: "Mr. Lee", class: "Creative Arts", block: "B3", level: "2", option: "2nd", status: "Pending" },
  ...
  { id: "6", student: "Maria Collins", parent: "Ms. Collins", class: "Journalism & Media Writing", block: "B4", level: "1", option: "2nd", status: "Approved" },
];
